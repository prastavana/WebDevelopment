...
function Home() {
    ...
    const {data: searchByName, refetch} = useQuery({
        ...
        queryFn: () => {
            return axios.get("http://localhost:8020/item/searchByName/" + searchData);
        },
        enabled: false,
    });
    ...
    const {data: productsByBrand, refetch: refetchProductsByBrand} = useQuery({
        ...
        queryFn: () => {
            return axios.get(`http://localhost:8020/item/getItemsByBrandName/${brandName}`);
        },
        enabled: false,
    });
    ...
    const { data: productsByCategory, refetch: refetchProductsByCategory } = useQuery({
        ...
        queryFn: () => {
            return axios.get(`http://localhost:8020/item/getItemsByCategoryName/${categoryName}`);
        },
        enabled: false,
    });
    ...
    return (
        <div className={"hm-container"}>
            <div className={"hm-top-bar"}>
                <div className={"hm-logo"}>
                    <a href="/dashboard">
                        <img width={100} src={"images/pngwing.com.png"} alt="Logo"/>
                    </a>
                </div>
                <div className={"hm-btn-one"}>
                    <div className={"hm-brands-dropdown"}>
                ...
                <div className={"hm-btn-cato"}>
                    <div className={"hm-categories-dropdown"}>
                ...
                <div className={"sb-searchButton"}>
                    <button type="submit" onClick={handleSearch}>
                        <i className="fa-solid fa-magnifying-glass"></i>
                    </button>
                </div>

                <div className={"hm-btn-four"}>
                    <Link to={"/cart"}>
            ...
            <div className={"hm-body"}>
                <div className={"hm-dashboard1"}>
                    <div className={"hm-img-dashboard1"}>
                        <Carousel>
                            ...
                            <Carousel.Item interval={2000}>
                                <img
                                    className="d-block w-100"
                                    src="images/kamado tanjiro.jpeg"
                                    alt="Third slide"
                                />
                            </Carousel.Item>
                        </Carousel>
                    ...
                    <div className={"product-dashboard1"}>
                ...
                <div className={"hm-dashboard2"}>
                    <div className={"hm-img-dashboard2"}>
                        <Carousel fade>
                    ...
                    <div className={"product-dashboard2"}>
